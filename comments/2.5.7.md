...
[note1:This requirement applies to mobile applications that interpret pointer actions (i.e., this does not apply to actions that are required to operate the [underlying platform software](#) or [assistive technology](https://www.w3.org/TR/WCAG22/#dfn-assistive-technologies)).]
