...
[note:Some user interface components such as tiles, cards, or list items may include multiple text components. The text that serves as the primary label must be contained in the name. Other visible text components must be exposed through other accessibility properties.]
