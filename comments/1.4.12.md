...
**1.4.12 Text Spacing:** In **[content](#content)** that supports the following text style properties, no loss of [content](#content) or functionality occurs by setting all of the following and by changing no other style property:
...
[note:If the [platform software](#platform-software) does not include a way for users to override text style properties, this success criterion is not applicable.]
