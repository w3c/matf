...
**Personal Content**
The cognitive function test is to identify [non-text content](https://www.w3.org/TR/WCAG22/#dfn-non-text-content) the user provided to the **[application software](#application-software)**.
...
[note:Any passwords used to unlock underlying [platform software](https://www.w3.org/TR/wcag2ict-22/#platform-software) itself are out of scope for this requirement since these are not under control of the [application software](#application-software)’s author.]

[note:There are cases where [application software](#application-software) has an authentication process and no alternative or assistance mechanism is feasible, for example when entering a password when starting, powering on / turning on an ICT (device or otherwise). In such situations, it may not be possible for the [application software](#application-software) to satisfy this success criterion.]
