...
[note:The WCAG2ICT interpretation is that a long press of a key (2 seconds or more) and other accessibility features provided by the [platform software](#platform-software) do not meet the WCAG definition of a keyboard shortcut. See the [keyboard shortcut](https://www.w3.org/TR/wcag2ict-22/#dfn-keyboard-shortcuts) definition for more details.]
