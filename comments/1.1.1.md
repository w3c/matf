...
[note:Not all [platform software](#platform-software) provide a way to programmatically associate a [label](https://www.w3.org/TR/WCAG22/#dfn-labels) with [non-text content](https://www.w3.org/TR/WCAG22/#dfn-non-text-content).]
